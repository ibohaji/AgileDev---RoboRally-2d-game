...
import App.RoborallyApplication.Model.EnumImageGraphics;
...
public class GameViewHelper {
    ...
    public static ImageIcon robotNorth = new ImageIcon(ImageUtils.getImage(EnumImageGraphics.ROBOT_NORTH.getElementLocation()));
    public static ImageIcon robotSouth = new ImageIcon(ImageUtils.getImage(EnumImageGraphics.ROBOT_SOUTH.getElementLocation()));
    public static ImageIcon robotEast = new ImageIcon(ImageUtils.getImage(EnumImageGraphics.ROBOT_EAST.getElementLocation()));
    public static ImageIcon robotWest = new ImageIcon(ImageUtils.getImage(EnumImageGraphics.ROBOT_WEST.getElementLocation()));
